...
public class DataSetTest {
    ...
    public void equals() throws Exception {
        DataSet setOne = new DataSet(ErrorHandler.getInstance());
        ...
        DataSet setTwo = new DataSet(ErrorHandler.getInstance());
        ...
        DataSet setThree = new DataSet(ErrorHandler.getInstance());
        ...
        DataSet setFour = new DataSet(ErrorHandler.getInstance());
